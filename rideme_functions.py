    ...
    def complete_booking(self, booking_id, rating):
        ...
        for b in self.bookings:
            if b.booking_id == booking_id and b.status == "active":
                ...
                self.save_driver_rating(b.driver_name, b.driver_plate, b.driver_number, rating, b.timestamp)
                return True
        return False
    ...
    def save_bookings(self, filename):
        ...
        try:
            with open(filename, 'w', newline='') as file:
                ...
                writer.writerow(["BookingID", "Start", "End", "Distance", "Vehicle", "Plate", "Driver", "Number", "ETA", "Status", "Timestamp", "Rating"])
                for b in self.bookings:
                    writer.writerow([
                        b.booking_id, b.start_location, b.end_location, b.distance,
                        b.vehicle.vehicle_type, b.driver_plate, b.driver_name, b.driver_number,
        ...
        try:
            with open(filename, 'r') as file:
                ...
                for row in reader:
                    ...
                    booking.driver_number = row["Number"]
